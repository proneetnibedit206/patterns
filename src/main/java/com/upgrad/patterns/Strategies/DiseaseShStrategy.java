...
public class DiseaseShStrategy implements IndianDiseaseStat {
    ...
    public String GetActiveCount() {
    	...
    	try{
            ...
            logger.info("in the GetActiveCount() of DiseaseShStrategy");
            DiseaseShResponse diseaseShResponse = this.getDiseaseShResponseResponses();
            Float cases = diseaseShResponse.getCases();
            return String.valueOf(Math.round(cases));
